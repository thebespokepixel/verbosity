...
const _console = _interopDefault(require('console'))
const termNG = _interopDefault(require('term-ng'))
const chalk = _interopDefault(require('chalk'))
const sparkles = _interopDefault(require('sparkles'))
const _thebespokepixel_time = require('@thebespokepixel/time')
...
const consoleFactory = function (options = {}) {
	const {outStream, errorStream, verbosity, timestamp, namespace, prefix} = options
